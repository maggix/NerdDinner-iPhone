 ...
 * @key:DinnerID* 
 */
@interface NerdDinnerModel_Dinner : ODataObject
{
	...
	* @FixedLength:false
	*/
	NSString *m_DinnerType;
	
	/**
	* @Type:NavigationProperty
	* @Relationship:FK_RSVP_Dinners
	* @FromRole:Dinners
	* @ToRole:RSVP
	*/
...
@property ( nonatomic , retain , getter=getDinnerType , setter=setDinnerType ) NSString *m_DinnerType;
 ...
 * @key:RsvpID* 
 */
@interface NerdDinnerModel_RSVP : ODataObject
{
 ...
 */
@interface NerdDinnerEntities : ObjectContext
{
